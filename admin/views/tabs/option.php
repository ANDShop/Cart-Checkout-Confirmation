...
<div class="drag-main ui-tabs-panel">
    ...
    <h3 class="free-text<?php echo $disabledClass; ?>"><?php echo esc_html__('Various settings can be changed by downloading the Pro version plugin (paid).', 'cart-checkout-confirmation'); ?></h3>
